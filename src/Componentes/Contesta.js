      ...
      {select_si_conecta_llamada  && (
            <div>
              ...
              <div className="form-row p-2 m-2 ">
                <label for="observacion"> ¿Entonces Sr. … Siendo el día de hoy (DD/MM/AAAA) acepta la contratación de “Sonríe Seguro”, con un cargo fijo mensual de S/. 29.90 en su tarjeta de crédito Ripley? - Esperar respuesta afirmativa del cliente (Sí - Sí acepto).
                </label>
              ...
              <div className="d-none" id="no_acepta">
                <p>
                  <strong> Agendo:</strong> Por supuesto (Primer nombre del cliente) se programará la llamada para el día (validar fecha con cliente). Muchas gracias, buenos días/buenas tardes/buenas noches
                </p>
              </div>
