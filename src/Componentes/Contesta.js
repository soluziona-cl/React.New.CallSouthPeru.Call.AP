...
function Contesta({
  ...
  const [agregarAdicional, setagregarAdicional] = useState(true);
  ...
  const [
    select_si_conecta_llamada_adicional,
    setSelectSiConectaLlamadaAdicional,
  ] = useState("0");
  const [select_cuantos_adicionales, setSelect_cuantos_adicionales] =
    useState("0");
  console.log("select_cuantos_adicionales =" + select_cuantos_adicionales);
  console.log(
    "select_si_conecta_llamada_adicional = " +
      select_si_conecta_llamada_adicional
  );
                        ...
                        <section>
                          <div className="mb-3  col-5">
                            ...
                            >
                              ...
                              <option value="3">Tercero + 3 adicionales</option>
                            </select>
                          </div>
                              ...
                              <strong>
                                ...
                                <section className="row">
                                  <div className="col-lg-3 col-md-3 col-sm-12 ">
                                    ...
                                    <select
                                      id="tipo_asegurado"
                                      value={tipo_asegurado1}
                                      onChange={(e) =>
                                        settipo_asegurado1(e.target.value)
                                      }
                                      className="form-select cliente"
                                    >
                                      <option value="0">Seleccione</option>
                          ...
                          <button
                            className="btn text-white btn-primary mb-4"
                            value={agregarAdicional}
                          >
                            Agregar
                          </button>
                        </section>
...
datosValidos === "1"( */}
      {(select_si_conecta_llamada === "1" &&
  select_si_conecta_llamada_adicional !== "0" &&
  select_cuantos_adicionales !== "0" &&
  datosValidos !== "") && (
            <div>
              ...
              <div className="form-row p-2 m-2 ">
                <label for="observacion">
                  ...
                  contratación de “Sonríe Seguro”, con un cargo fijo mensual de
                  S/. 29.90 en su tarjeta de crédito Ripley? - Esperar respuesta
              ...
              {select_conecta_llamada_pregunta_interesa === "2" && (
                <div className="col-12 p-3">
                  <div id="vw_script_cliente_nointeresa" className="">
                    ...
                    <p>
                      Cuando NO desea, me despido. Cuando solicita se le llame
                      en otra oportunidad, se agenda nueva llamada.
                    </p>
                    <p>
                      <strong> Agendo:</strong> Por supuesto (Primer nombre del
                      cliente) se programará la llamada para el día (validar
                      fecha con cliente). Muchas gracias, buenos días/buenas
                      tardes/buenas noches
                    </p>
                    <div className=" card-body">
                      <div className="form-row">
                        <label for="observacion">
                          Me podria decir la razon por la cual no desea
                          contratar el seguro ?
                        </label>
                      </div>
                ...
                <div id="vw_script_cliente_valida" class="">
                  ...
                  <section className=" mt-2 ">
                    <div className=" m-4 ">
                      ...
                      <p>
                        Adicionalmente, vamos a validar sus datos para el
                        correcto envío de la póliza.
                      </p>
                    </div>
                  ...
                  <div className="card " id="pre_cierre">
                    ...
                    <div className=" card-body">
                      <div>
                        <label for="observacion">
                          ¿Don/Sra. XXXX, Usted desea que le enviemos su Póliza
                        ...
                        {selectConectaLlamadaPreguntaConfirma === "1" && (
                          <div className="my-4" id="si_correo">
                            <p>
                              Muy bien Sr/Sra. XXXXXX le recuerdo que el envío
                              de tu Solicitud-Certificado digital es el sustento
                              de la contratación del presente seguro. Entonces
                              le estaremos enviando el mismo al correo XXXXX
                              declarado por usted, en un plazo de 15 DIAS
                              CALENDARIO, contados a partir del día de hoy.
                            </p>
                          </div>
                        )}
                        {selectConectaLlamadaPreguntaConfirma === "2" && (
                          <div className="my-4" id="no_correo">
                            <p>
                              Te estaremos enviando la Solicitud-Certificado a
                              tu domicilio en 15 días calendario, contados a
                              partir del día de hoy Revalidar (LA DIRECCIÓN:
                  ...
                  <div id="vw_script_cliente_despedida" className="">
                    ...
                    <div className="card card-body">
                      <div className="form-row col-12 text-justify">
                        <p>
                          Por cualquier consulta puede comunicarse con nosotros
                          al Banco Ripley al 611-5757 o a Chubb Seguros Perú al
                          (01) 3991212 de lunes a viernes de 9:00am a 6:00pm.
                          Sr. XXX le agradezco su atención y su tiempo, a nombre
                          del Banco Ripley y Chubb Seguros Perú le damos una
                          cordial bienvenida; se despide que tenga buenos (días,
                          tardes, noches).
                        </p>
                      </div>
                      <div className="d-flex justify-content-end">
