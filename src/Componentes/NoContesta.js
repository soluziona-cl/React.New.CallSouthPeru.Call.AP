 ...
 <div className="row my-2">
        ...
        <div className="col-lg-3 col-sm-6 my-2">
          <select className="form-select" aria-label="Default select example">
            ...
            <option value="2">Problema de línea de salida - Congestionado</option>
            <option value="3">Teléfono Ocupado</option>
            <option value="4">Teléfono conectado a Fax</option>
            <option value="5">Fuera de área o apagado</option>
            <option value="6">Grabadora o buzón de voz</option>
            <option value="7"> Número no válido </option>
          </select>
        </div>
      </div>
