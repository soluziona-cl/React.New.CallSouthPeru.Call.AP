...
const Callintro = () => {
        ...
        const ValidaCall = async() => {
            const result = await axios.post(
                "https://app.soluziona.cl/API_v1_prod/Soluziona/Generacc/Call/api/Ventas/Validacall", { userName: "test", password: "test" }
            );
        ...
        const DatosCliente = async(lead, clave) => {
            const result = await axios.post(
                "https://app.soluziona.cl/API_v1_prod/Soluziona/Generacc/Call/api/Ventas/Call/DatosCliente", { dato: lead }, { headers: { Authorization: `Bearer ${clave}` } }
            );
        ...
        const GuardaURL = async(agentes, url, clave) => {
            const result = await axios.post(
                "https://app.soluziona.cl/API_v1_prod/Soluziona/Generacc/Call/api/Ventas/Call/SaveURl", { dato: agentes, dato_2: url }, { headers: { Authorization: `Bearer ${clave}` } }
            );
        ...
        const Conecta = async(clave) => {
            const result = await axios.post(
                "https://app.soluziona.cl/API_v1_prod/Soluziona/Generacc/Call/api/Ventas/Call/Conecta", { dato: company }, { headers: { Authorization: `Bearer ${clave}` } }
            );
        ...
        async function GuardarRegistroNoContesta() {
            ...
            const result = await axios.post(
                "https://app.soluziona.cl/API_v1_prod/Soluziona/Generacc/Call/api/Ventas/Call/GuardaGestion", { dato: id }, { headers: { Authorization: `Bearer ${token}` } }
            );
        ...
        async function GuardarRegistro() {
            ...
            if (anio <= edadMaxima) {
                ...
                if (nombres === '' || apellido_paterno === '' || apellido_materno === '' || fecha_nacimiento === '' || RutCliente === '' || sexo === '' || email === '' || planes === '' || comuna === '' || ciudad === '' || calle === '' || numero === '' || depto === '' || referencia === '') { console.log('campo vacio') } else {
        ...
        return ( <
                ...
                span id = "duracion"
                className = "cliente" > { get_elapsed_time_string(elapsedSeconds) } <
                /span> <
                /h4> <
                /div> <
                ...
                <
                select className = "cliente form-control form-select my-3"
                id = "selectLlamada"
                value = { selectLlamada }
                onChange = {
                    (e) => ChangeLlamada(e.target.value) } >
                <
                ...
                /section> {
                    selectLlamada === "2" && ( <
                        ...
                        <
                        NoContesta company = { selectLlamada }
                        clave = { token }
                        ...
                        /div> {
                            datafull.map((data, index) => ( <
                                ...
                                div className = "row" >
                                <
                                div className = "col-4 offset-8 text-right position-fixed"
                                style = {
                                    { top: 0, right: 0, zIndex: 9999 } } >
                                Nombre Completo <
                                /div> <
                                div className = "col-4 offset-8 position-fixed"
                                style = {
                                    { top: 30, right: 0, zIndex: 9999 } } >
                                <
                                input name = "roomRent"
                                type = "text"
